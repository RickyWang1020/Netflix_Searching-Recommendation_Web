...
const RatingOverTime = () => {
    ...
    const search = () => {
        fetch(`http://${config.server_host}:${config.server_port}/genre_rating_change/${genre}`)
    ...
    return (
        <div className='stats-panel'>
            <div className='title'>Movie Average Rating Over Time by Genre</div>
...
ReactDOM.render(<RatingOverTime />, document.getElementById('root'));